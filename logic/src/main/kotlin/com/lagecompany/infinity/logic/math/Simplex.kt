...
object SimplexNoise {  // Simplex noise in 2D
    private val grad3 = arrayOf(Grad(1.0, 1.0), Grad(-1.0, 1.0), Grad(1.0, -1.0), Grad(-1.0, -1.0), Grad(1.0, 0.0), Grad(-1.0, 0.0), Grad(1.0, 0.0), Grad(-1.0, 0.0), Grad(0.0, 1.0), Grad(0.0, -1.0), Grad(0.0, 1.0), Grad(0.0, -1.0))
    ...
    private fun noise(xin: Double, yin: Double): Double {
        ...
        val t = (i + j) * G2
        val xx0 = i - t // Unskew the cell origin back to (x,y) space
        val yy0 = j - t
        val x0 = xin - xx0 // The x,y distances from the cell origin
        val y0 = yin - yy0
